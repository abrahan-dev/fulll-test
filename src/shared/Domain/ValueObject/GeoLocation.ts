export class GeoLocation {
    ...
    constructor(longitude: number, latitude: number, altitude?: number) {
        ...
        this.coordinates = altitude !== undefined ? [longitude, latitude, altitude] : [longitude, latitude];
    }

    private ensureValidCoordinates(longitude: number, latitude: number, altitude?: number): void {
    ...
    public equals(other: GeoLocation): boolean {
        return (
            ...
            (this.coordinates[2] === other.coordinates[2] || (this.coordinates[2] === undefined && other.coordinates[2] === undefined))
        );
    }
